        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <template #item="product">
                        <div class="product-item">
                            <div class="product-item-content">
                                <div class="mb-3">
                                    <img :src="'images/gits/' + product.data.image" :alt="product.data.name"
                                        style="width: 50%;" class="product-image" />
                                </div>
                                <div>
                                    <h4 class="mb-1">
                                        {{ product.data.name }}
                                ...
                                <div>
                                    <div class="col-12">
                                        <Button type="button" label="Price for experience and excursion"
                ...
                <Dialog header="Cars" v-model:visible="display2" :breakpoints="{'960px': '100vw'}"
                    ...
                    <DataTable :value="guide" v-model:selection="selectedProduct" selectionMode="single"
                        :paginator="true" :rows="5" @row-select="onProductSelect" responsiveLayout="scroll">
                        <Column field="name" header="Excursion" :sortable="true" headerStyle="min-width:10rem;">
                            <template #body="g">
                                {{(g.data.excursion)}}
                            </template>
                        </Column>
                        <Column field="name" header="Experience" :sortable="true" headerStyle="min-width:10rem;">
                            <template #body="g">
                                {{(g.data.experience)}}
                            </template>
                        </Column>
...
export default {
    ...
    methods: {
        ...
        toggleDataTable(event) {
            this.guide = this.products[event - 1].guide;
            this.display2 = true;
